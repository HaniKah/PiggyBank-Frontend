...
export default function Link({ id }) {
  ...
  const handleGetTransaction = async () => {
    ...
    const response = await fetch(
      `https://piggybank-api-utda.onrender.com/api/transactions/${id}`,
      {
  ...
  const onSuccess = useCallback((public_token) => {
    ...
    const exchangePublicTokenForAccessToken = async () => {
      const response = await fetch(
        "https://piggybank-api-utda.onrender.com/api/set_access_token",
        {
  ...
  return (
    ...
    >
      <Box style={{ display: "flex", flexDirection: "column" }}>
        ...
        >
          PiggyBank lets you link your bank account, sync transactions securely
          using PLAID technology. Try it now!
        </Typography>
